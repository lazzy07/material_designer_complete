...
import * as animationData from "../../../animations/content_delivery/data.json";

export default class MaterialContentDelivery extends Component {
  render() {
    return (
      <div>
        <Description AnimationData={animationData}>
          <h3>Material Designer - Content Delivery</h3>
          ...
          Minima voluptas suscipit tempore eum voluptatibus nam autem ducimu
          ...
          unde labore accusantium maxime repellendus itaque et blanditiis.
        </Description>
      </div>
    );
  }
