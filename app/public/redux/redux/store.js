...
exports.rendererStore = function () {
    ...
    var store = redux_1.createStore(reducers_1.rootReducer, initialState, redux_1.compose(redux_1.applyMiddleware(electron_redux_1.forwardToMain, redux_thunk_1.default), (window.__REDUX_DEVTOOLS_EXTENSION__ &&
        window.__REDUX_DEVTOOLS_EXTENSION__()) ||
        redux_1.compose));
    electron_redux_1.replayActionRenderer(store);
    return store;
};
