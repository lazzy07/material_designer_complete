...
exports.systemReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case SystemActions_1.SET_SELECTED_NODE:
            return __assign({}, state, { selectedNode: action.payload });
        case SystemActions_1.SET_IMAGE_VIEWER_NODE:
            return __assign({}, state, { viewerNodeId: action.payload });
        case SystemActions_1.SET_IMAGE_VIEWER:
            return __assign({}, state, { imageViewer: action.payload });
        default:
            return state;
    }
};
